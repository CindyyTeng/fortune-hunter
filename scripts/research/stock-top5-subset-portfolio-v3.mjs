...
const OUTPUT = new URL('../../data/research/stock-top5-subset-portfolio-v3.json', import.meta.url);
const REPORT = new URL('../../docs/STOCK_TOP5_SUBSET_PORTFOLIO_V3.md', import.meta.url);
...
async function main() {
  ...
  const output = {
    ...
    strategyId: 'stock_top5_subset_portfolio_v3',
