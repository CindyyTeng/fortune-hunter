...
const OUTPUT = new URL('../../data/research/stock-near-high-kd-fixed-v2.json', import.meta.url);
const REPORT = new URL('../../docs/STOCK_NEAR_HIGH_KD_FIXED_V2.md', import.meta.url);
...
async function main() {
  const identityInput = {
    strategyId: 'stock_near_high_kd_fixed_v2',
    dataSources: ['tw_backtest_candidate_features', 'stochastic_rsi_features', 'daily_ohlcv'],
    setupRules: ['純個股近年高附近', 'KD 小於 70', '排除弱量', '盡量貼近 forward scan 條件'],
