...
- `12-1 momentum`：觀察約半年中期趨勢，但跳過最近一個月，降低短期過熱干擾
- `near-year-high`：貼近年高但未完全鈍化者加分
- `20-day drawdown`：近 20 日回撤過深者扣分
...
- `ALLOW_ORIGIN=*`
- `MAX_SYMBOLS=12`
- `SYMBOLS=2330.TW,...`：只有你要強制指定固定清單時才需要
